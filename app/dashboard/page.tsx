    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1">
          Upload curriculum PDFs to train the AI Assistant.
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 text-slate-700 bg-slate-50 border border-[#0f46acc9] rounded-xl outline-none input: text-slate- 700 "
            >
              <option value="" className="text-slate-700">
                -- Choose a faculty --
              </option>
              <option value="SEET" className="text-slate-700">
                SEET
              </option>
